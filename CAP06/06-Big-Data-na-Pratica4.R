...
install.packages("mnvtnorm")
install.packages("modeltools")
install.packages("stast4")
install.packages('topepo/caret/pkg/caret')
...
?ctree
tree <- ctree(churn$Contract~churn$Contract+tenure_group+PaperlessBilling, training)
...
##### Random Forest #####
install.packages("rfModel", dependencies = T)
set.seed(2017)
?randomForest
...
# Confusion Matrix
print("Confusion Matrix Para Random Forest");
