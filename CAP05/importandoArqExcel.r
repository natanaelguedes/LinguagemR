...
df4=excel_sheets("CAP05/UrbanPop.xlsx")
df4
# Lendo a planilha do Excel
read_excel("CAP05/UrbanPop.xlsx")
head(read_excel("CAP05/UrbanPop.xlsx"))
read_excel("CAP05/UrbanPop.xlsx", sheet = "Period2")
read_excel("CAP05/UrbanPop.xlsx", sheet = 3)
read_excel("CAP05/UrbanPop.xlsx", sheet = 4)
...
df_todas <- lapply(excel_sheets("CAP05/UrbanPop.xlsx"), read_excel, path = 'CAP05/UrbanPop.xlsx')
df_todas
class(df_todas)
...
# Namespace
arq1 = XLConnect::loadWorkbook("CAP05/UrbanPop.xlsx")
...
?read.xlsx
df2 <- read.xlsx("CAP05/UrbanPop.xlsx", sheetIndex = 1)
df2
